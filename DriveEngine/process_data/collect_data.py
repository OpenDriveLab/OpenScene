...
if __name__ == '__main__':
    mini_infos = os.listdir('data/openscene-v1.1/meta_datas/mini')
    mini_infos = [os.path.join('data/openscene-v1.1/meta_datas/mini', each) for each in mini_infos if each.endswith('.pkl')]
