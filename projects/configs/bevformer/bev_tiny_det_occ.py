...
train_pipeline = [
    ...
    dict(type='CustomCollect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'points', 'occ_gts'])
]
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        ann_file='/nvme/liyang/Datasets/nuScenes/occupancy/nuscenes_infos_temporal_80_train.pkl',
