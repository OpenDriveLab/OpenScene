...
# data_root = '/nvme/liyang/Datasets/nuPlan/nuplan-v1.1/sensor_blobs'
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        ann_file='/cpfs01/user/liyang/zhouys/Datasets/nuPlan/occupancy/nuscenes_infos_temporal_train.pkl',
        # ann_file='/home/liyang/zhouys/Git_repos/OccupancyNetwork_nuplan/nuscenes_val.pkl',
        # ann_file='/nvme/liyang/Datasets/nuScenes/occupancy/nuscenes_infos_temporal_val_occ_gt.pkl',
    ...
    val=dict(type=dataset_type,
             ...
             data_root=data_root,
            #  ann_file='/nvme/liyang/Datasets/nuScenes/occupancy/nuscenes_infos_temporal_val_occ_gt.pkl',
             ann_file='/cpfs01/user/liyang/zhouys/Datasets/nuPlan/occupancy/nuscenes_infos_temporal_val.pkl',
