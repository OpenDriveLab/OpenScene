"""
基于保存的detection-> occupancy 预测和gt计算各项指标
"""
import numpy as np
import os  
...
import shutil
import json 
sys.path.append('./projects/mmdet3d_plugin/datasets/')
...
def main(box_gt_dir, box_det_dir, occ_gt_dir, consider_partial_scene=False, occ_type='coarse'):
    ...
    # print(f'======out evaluation metrics 3D box gt =========')
    # eval_resuslt = eval_metrics_box_gt.get_stats()
