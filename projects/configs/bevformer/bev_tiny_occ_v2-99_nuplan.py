...
# imput image size: 1920*1080
# multi-scale feautres -> single scale features (C5)
# occ gt is generated from lidarseg
# point cloud range [-50, 50], occupancy_size = 0.5
...
# point_cloud_range = [-50.0, -50.0, -5.0, 50.0, 50.0, 3.0] changed
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(1600, 900), #ToDo: change to 1920*1080
        pts_scale_ratio=1,
        flip=False,
        transforms=[
            dict(type='RandomScaleImageMultiViewImage', scales=[0.5]),
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        ann_file='/cpfs01/user/zhouyunsong/zhouys/Datasets/nuPlan_PlayGround/occupancy/nuscenes_infos_temporal_train_fixed.pkl',
    ...
    val=dict(type=dataset_type,
             load_occ_lidarseg=True,
             data_root=data_root,
             ann_file='/cpfs01/user/zhouyunsong/zhouys/Datasets/nuPlan/occupancy/nuscenes_infos_temporal_val.pkl',
...
# load_from = './ckpts/vovnet99_ese_detectron2.pth'
load_from = './ckpts/vovnet99_imagenet_pretrain.pth'
# resume_from = '/cpfs01/user/liyang/zhouys/Git_repos/OccupancyNetwork_nuplan/work_dirs/bev_tiny_occ_v2-99_nuplan/latest.pth'
