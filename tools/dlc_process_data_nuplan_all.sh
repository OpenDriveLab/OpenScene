...
python ./process_data/create_nuplan_data_dlc.py \
    --data_root="/cpfs01/shared/opendrivelab/opendrivelab_hdd/nuplan/dataset/nuplan-v1.1/" \
    --data_split="trainval_sensor" \
    --occ_res='normal' \
    --out_dir='/cpfs01/shared/opendrivelab/opendrivelab_hdd/zhouys/occupancy_dlc/trainval' \
    --log_start=0 \
    --log_length=126 \
    --num_thread=126
