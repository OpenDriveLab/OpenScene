...
if __name__ == '__main__':
    data_dir = '/nvme/liyang/Datasets/nuPlan/occupancy/trainval'
    gt_dir = 'occ_gts' 
    pred_dir = 'occ_preds'
    ...
    for scene_name in os.listdir(data_dir):
        ...
        for frame_name in os.listdir(os.path.join(data_dir, scene_name, 'occ_gt')):
            ...
            if occ_valid and out_flow == False:

                index = frame_id

                gt_occ_file_name = frame_name
                occ_gt = np.load(os.path.join(data_dir, scene_name, 'occ_gt', gt_occ_file_name))
                occ_gt = np.load('/nvme/liyang/Datasets/nuPlan/occupancy/trainval/log-0001-scene-0001/occ_gt/000_occ_final.npy')
            ...
            if flow_valid and out_flow == True:
