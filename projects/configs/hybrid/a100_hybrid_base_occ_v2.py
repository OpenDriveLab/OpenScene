...
_pos_dim_ = _dim_//2
_ffn_dim_ = _dim_*2
_num_levels_ = 3 # set 4 is OOM, set 3: memory 80G
bev_h_ = 200
bev_w_ = 200
bev_z_ = 16
...
voxel_encoder1_dim = _dim_
voxel_encoder2_dim = _dim_
voxel_encoder3_dim = _dim_//2  
voxel_encoder4_dim = _dim_//2
bev_z1 = 2
bev_z2 = 4
bev_z3 = 8
bev_z4 = 16
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        use_occ_gts=use_occ_gts,
        load_occ_lidarseg=load_occ_lidarseg,   # 10 foreground + 6 background 
        data_root=data_root,
        ceph_dir='nuscenes:s3://openmmlab/datasets/detection3d/nuscenes',
        ann_file='data/nuscenes_occupancy/nuscenes_infos_temporal_train_occ_gt.pkl',
    ...
    val=dict(type=dataset_type,
             ...
             data_root=data_root,
             ceph_dir='nuscenes:s3://openmmlab/datasets/detection3d/nuscenes',
             ann_file='data/nuscenes_occupancy/nuscenes_infos_temporal_val_occ_gt.pkl',
