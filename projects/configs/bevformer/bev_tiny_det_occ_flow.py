...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        load_occ_post=False,  # load occ_gt or occ_gt_post
        load_occ_lidarseg=True,   # 10 foreground + 6 background
        load_occ_invalid=True,  # invalid occ for validation
        data_root=data_root,
        ann_file='/mnt/lustrenew/share_data/tongwenwen1/public_datasets/nuscenes_lidar/accumulate_v2/nuscenes_infos_temporal_train_occ_gt.pkl',
    ...
    val=dict(type=dataset_type,
             ...
             load_occ_invalid=True,  # invalid occ for validation
             data_root=data_root,
             ann_file='/mnt/lustrenew/share_data/tongwenwen1/public_datasets/nuscenes_lidar/accumulate_v2/nuscenes_infos_temporal_val_occ_gt.pkl',
